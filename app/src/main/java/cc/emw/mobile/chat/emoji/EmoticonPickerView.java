...
import cc.emw.mobile.util.BitmapDecoder;
...
public class EmoticonPickerView extends LinearLayout implements IEmoticonCategoryChanged {
    ...
    private CheckedImageButton addEmoticonTabBtn(int index, OnClickListener listener) {
        ...
        emotBtn.setPaddingValue(UiUtil.dip2px(context,7));

        final int emojiBtnWidth = UiUtil.dip2px(context,50);
        final int emojiBtnHeight = UiUtil.dip2px(context,44);
